...
async function sendToESP32() {
  console.log("Enviando dato a ESP32");
  const response = await fetch("http://esp32.local:80", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
    body: JSON.stringify({ message: "Hello ESP32" }),
  });
        ...
        <BaseBlock class="d-flex flex-column h-100 mb-0">
          <template #content>
            ...
            >
              ...
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">ESP32</dt>
                <dd class="fs-sm fw-medium text-muted mb-0">Envia dato</dd>
              </dl>
              <div class="item item-rounded-lg bg-body-light">
      ...
      <div class="col-sm-6 col-xxl-3">
        ...
        <BaseBlock class="d-flex flex-column h-100 mb-0">
          <template #content>
            ...
            >
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">Arduino</dt>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">
                  Ejemplo
                </dd>
              </dl>
      ...
      <div class="col-sm-6 col-xxl-3">
        ...
        <BaseBlock class="d-flex flex-column h-100 mb-0">
          <template #content>
            ...
            >
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">Ejemplo</dt>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">
                  Ejemplo
                </dd>
              </dl>
